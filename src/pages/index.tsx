...
export default function Home() {
  return (
    <Container flex style='flex'>
      <article className='flex items-center justify-center w-3/4 relative'>
        <Image
      ...
      <article className='flex flex-col gap-3 px-10 items-center justify-center w-1/2'>
        ...
        <Link
          href='/selectPlayer'
          className='bg-gradient-to-br px-7 py-4 from-amber-800 to-stone-700 text-white font-semibold font-play rounded flex gap-1 items-center shadow-md shadow-neutral-500 active:translate-y-2 transition-all duration-150 ease-out'
        >
